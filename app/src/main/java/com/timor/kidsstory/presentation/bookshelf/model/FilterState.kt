...
enum class FilterLevel(
    ...
    ONE(1, ReadingLevel.FIRST_STEPS, "1", R.string.level_1),
    TWO(2, ReadingLevel.EARLY_READER, "2", R.string.level_2),
    THREE(3, ReadingLevel.GROWING_READER, "3", R.string.level_3),
    FOUR(4, ReadingLevel.CONFIDENT_READER, "4", R.string.level_4),
    FIVE(5, ReadingLevel.ADVANCED_READER, "5", R.string.level_5)
}

 ...
 * @property pageType 페이지 레이아웃 타입 (SPLIT, FULL_IMAGE 등)
...
data class Page(
    ...
    val pageType: String = "SPLIT", // 새로 추가된 필드
    ...
    // 페이지 타입별 레이아웃 확인
    val isSplitLayout: Boolean get() = pageType == "SPLIT"
    val isFullImageLayout: Boolean get() = pageType == "FULL_IMAGE"
}
